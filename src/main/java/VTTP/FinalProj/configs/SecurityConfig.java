...
public class SecurityConfig{
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity)throws Exception{
        ...
        httpSecurity.cors().and().csrf().disable()
            .authorizeHttpRequests().requestMatchers("/auth/**", "/", "/3rdpartylicenses.txt", "/", "/favicon.ico", "/index.html", "/main.3d34eddf807c86f5.js", "/manifest.webmanifest", "/polyfills.d81bfc265aeaed00.js", "/runtime.924b27b870857f62.js", "/styles.f3c0eb0d5cfdf978.css", "/assets/**", "/images/**","/icon-192x192.png","/icon-256x256.png","/icon-384x384.png","/icon-512x512.png", "/Dreamcatcher.11b799e9474b39a0.png")
            .permitAll().anyRequest().authenticated()
            .and().sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS)
            .and().authenticationProvider(authProvider)
            .addFilterBefore(jwtRequestFilter, UsernamePasswordAuthenticationFilter.class);
